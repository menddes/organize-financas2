...
const DashboardCharts: React.FC<DashboardChartsProps> = ({ currentMonth = new Date(), hideValues = false }) => {
  ...
  console.log("Rendering charts with filtered transactions:", filteredTransactions.length);
  
  // Generate data for the current month using actual transactions
  const monthData = generateChartData(filteredTransactions, currentMonth);
