...
const WhatsAppActivationButton: React.FC = () => {
  ...
  const handleActivateAccount = () => {
    // Substitua:
    window.open('https://wa.me/5534998773972?text=Quero%20ativar%20minha%20conta', '_blank');
    
    // Por:
    window.open(`https://wa.me/${import.meta.env.VITE_CONTACT_PHONE}?text=Quero%20ativar%20minha%20conta`, '_blank');
    setIsOpen(false);
  };
