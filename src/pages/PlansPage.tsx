  ...
  const plans = [
    {
      ...
      price: config?.prices.monthly.displayPrice || `R$ ${import.meta.env.VITE_PLAN_PRICE_MONTHLY || '29,90'}`,
      period: "/mês",
      priceId: config?.prices.monthly.priceId || import.meta.env.VITE_STRIPE_PRICE_ID_MONTHLY,
    ...
    {
      name: t('plans.annual'),
      price: config?.prices.annual.displayPrice || `R$ ${import.meta.env.VITE_PLAN_PRICE_ANNUAL || '177,00'}`,
      period: "/ano",
      priceId: config?.prices.annual.priceId || import.meta.env.VITE_STRIPE_PRICE_ID_ANNUAL,
      originalPrice: config?.prices.annual.displayOriginalPrice || `R$ ${import.meta.env.VITE_PLAN_PRICE_ANNUAL_ORIGINAL || '238,80'}`,
      savings: config?.prices.annual.displaySavings || `Economize ${import.meta.env.VITE_PLAN_SAVINGS_ANNUAL || '25'}%`,
