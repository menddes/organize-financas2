...
-- Inserir o primeiro usuário admin (substitua pelo email do usuário que deve ser admin)
-- Você precisará ajustar este email para o usuário que deve ter acesso admin
INSERT INTO public.user_roles (user_id, role)
SELECT id, 'admin'::app_role
FROM auth.users
WHERE email = 'userdemo@gmail.com'
